...
```text
dist/release/peeragent_0.2.4_linux_amd64.tar.gz
dist/release/peeragent_0.2.4_linux_arm64.tar.gz
dist/release/peeragent_0.2.4_darwin_amd64.tar.gz
dist/release/peeragent_0.2.4_darwin_arm64.tar.gz
...
```sh
make publish-release VERSION=0.2.4
```
